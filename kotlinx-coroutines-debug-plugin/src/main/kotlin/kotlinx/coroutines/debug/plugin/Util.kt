 ...
 */
object PathUtil {
    const val DEFAULT_AGENT_PARAMS = "loglevel=info,datafile="
    const val DEBUG_AGENT_NAME = "coroutines-debug-agent.jar"

    private val AGENT_DIR_NAME = "agent"
    private val NO_PATH = File("<no_path>")

    val JAVAAGENT_VM_PARAM = "-javaagent:${DEBUG_AGENT_PATH.absolutePath}=$DEFAULT_AGENT_PARAMS"

    val DEBUG_AGENT_PATH: File
