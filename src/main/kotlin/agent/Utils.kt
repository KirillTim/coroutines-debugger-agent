...
fun isAnonymousSuspendFunction(instructions: InsnList): Boolean { //FIXME
    val getSuspendedConst = instructions.get(0)
    val l0 = instructions.get(1)
    val getLabel = instructions.get(5)
    val tableSwitch = instructions.get(6)
